# sybex-1Z0-831-chapter-12

Code and commands from [OCP Oracle Certified Professional Java SE 25 Study Guide: Exam 1Z0-831 by Scott Selikoff and Jeanne Boyarsky](TBD)
...
Also see:
* Our [main book page](https://www.selikoff.net/ocp25/)
...
```
Alternate form of javac command
```
